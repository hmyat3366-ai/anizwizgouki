...
export const TheInfiniteGrid = () => {
  ...
  return (
    <div
      ...
      className={cn(
        "absolute inset-0 w-full h-full flex flex-col items-center justify-center overflow-hidden pointer-events-auto"
      )}
    >
      ...
      <div className="absolute inset-0 pointer-events-none z-0">
        ...
        <div className="absolute right-[10%] top-[-10%] w-[20%] h-[20%] rounded-full bg-indigo-500/20 dark:bg-lime-400/10 blur-[100px]" />
