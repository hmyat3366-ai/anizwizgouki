  ...
  return (
    <>
      ...
      <button
        ...
        className={`fixed bottom-6 right-6 md:bottom-8 md:right-10 z-[200] bg-primary text-primary-foreground w-14 h-14 sm:w-16 sm:h-16 rounded-full shadow-[0_10px_40px_rgba(0,0,0,0.3)] transition-all duration-500 hover:scale-105 active:scale-95 flex items-center justify-center border border-border/10 group overflow-hidden ${
      ...
      >
        ...
        <span className="relative z-10 flex items-center justify-center">
          ...
          <span className="absolute -top-1 -right-1 flex h-3 w-3">
            ...
            <span className="relative inline-flex rounded-full h-3 w-3 bg-primary shadow-[0_0_8px_currentColor]"></span>
          </span>
        </span>
      </button>
